...
export default function RatingPreview({ rating }) {
  return (
    <div>
      ...
      <h3 className="text-center font-semibold text-stone-50 text-base sm:text-lg lg:text-xl mb-4">"{rating.headline}"</h3>
      <div className="flex justify-center gap-5 mb-6">
        ...
        <h4 className="text-center font-semibold text-stone-50 text-lg sm:text-xl lg:text-2xl">{rating.score}.0</h4>
      </div>
      <p className='text-xs sm:text-[.82rem] lg:text-sm text-stone-400 text-center'>Rated on {formatDate(rating.last_update)}</p>
    </div>
  );
}